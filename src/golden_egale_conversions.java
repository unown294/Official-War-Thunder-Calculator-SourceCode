...
public class golden_egale_conversions {
    ...
    public static String Lowest_Possible_ge(int Ge){
...
//            }
        ...
        return(String.format("You need to buy the following packs to ensure that you will have the ammount\nDesired in the lowest possible ammount:\n%d pack : %d\n%d pack : %d\n%d pack : %d\n%d pack : %d\n%d pack : %d\n%d pack : %d\n-The total cost is: $%,.2f\n-Total GE bought: %d",ge_ammount[0],tally_ammount[0],ge_ammount[1],tally_ammount[1],ge_ammount[2],tally_ammount[2],ge_ammount[3],tally_ammount[3],ge_ammount[4],tally_ammount[4],ge_ammount[5],tally_ammount[5], total_cost, total_eagles));    
